...
def computer():
    if new_list[4] != "o" and new_list[4] != "x":
        ...
        new_list[1] = "x"
        computer_moves.append(2)
    elif new_list[2] != "o" and new_list[2] !="x" and ((new_list[0]=="o" and new_list[1]=="o") or (new_list[5]=="o" and new_list[8]=="o")or (new_list[4]=="o" and new_list[6]=="o")):
        new_list[2] = "x"
        computer_moves.append(3)
    elif new_list[3] != "o" and new_list[3] !="x" and ((new_list[4] == "o" and new_list[5]=="o") or (new_list[0]=="o" and new_list[6]=="o")):
        new_list[3] = "x"
        computer_moves.append(4)
    elif new_list[5]!="o" and new_list[5]!="x" and ((new_list[3]=="o" and new_list[4]=="o") or (new_list[2]=="o" and new_list[8]=="o")):
        new_list[5] = "x"
        computer_moves.append(6)
    elif new_list[6]!="o" and new_list[6]!="x" and ((new_list[0]=="o" and new_list[3]=="o") or(new_list[7]=="o" and new_list[8]=="o")or(new_list[4]=="o"and new_list[2]=="o")):
        new_list[6]="x"
        computer_moves.append(7)
    elif new_list[7]!="o" and new_list[7]!="x" and ((new_list[1]=="o" and new_list[4]=="o") or (new_list[6]=="o"and new_list[8]=="o")):
        new_list[7]="x"
        computer_moves.append(8)
...
def main():
    while True:
        question = input("play other person or computer or quit p/c/q ")
        if question == "p":
